...
>
  ...
  <span style={{ color: "#F47F2A", fontWeight: "bold" }}>
    ...
    <Box sx= {{backgroundcolour: "#F47F2A:4%"}}>
    <Container sx={{marginTop:"5rem"}}>
        <CustomBox>
          <CongratCard buttonText="Click Me"/>
          <CongratCard />
          <CongratCard />
        {/* <div
    >
      ...
      />
      <h2 sx={{ fontSize: '1.2em', marginBottom: '8px' }}>Card 1</h2>
      <p sx={{ fontSize: '1em', color: '#666' }}>"This is the content for Card 1."</p>
      <CustomButton
              backgroundColor="#F47F2A"
              color="#fff"
              buttonText="Register"
