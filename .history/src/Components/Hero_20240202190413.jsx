...
>
  <span sx={{color:"#fffff"}}>Educate a Child  </span>{" "}
  <br />
        ...
        >
          ...
          <Box sx={{ flex: "0.75" }}>
            ...
            sx={{
              ...
              height: '100px', // Set half of your desired height
              overflow: 'hidden',
              clipPath: 'ellipse(100px 50px at 50% 0%)', // Creates a semicircular clip path
