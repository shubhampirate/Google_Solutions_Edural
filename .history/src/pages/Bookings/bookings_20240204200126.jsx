...
const educationEvents = [
  { id: 1, name: 'Bandar Packhadi Muncipal School', description: 'Primary School' },
  { id: 2, name: 'Kurar Village Parekh Nagar BMC School', description: 'Primary and Secondary School' },
  { id: 3, name: 'Marol Marathi BMC School', description: 'K12 School' },
];
      ...
      <Box sx={{ display: 'flex', borderRadius: '16px', overflow: 'hidden', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }}>
        ...
        >
          ...
          {tabValue === 0 && (
           ...
           {/* First line of cards */}
           <Grid container item justifyContent="center" marginBottom="3.5rem">
           ...
           <Grid container item justifyContent="center" marginTop="3.5rem">
           <Grid item xs={12} sm={6} md={4} lg={4}>
               <ImageCard
                 imageSrc={heroImg}
                 schoolName="School 1"
...
//           
          ...
          {tabValue === 1 && (
            ...
            <Grid container spacing={2} marginTop="1rem" paddingLeft={5}  >
                <Grid item xs={7}>
                    ...
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d64676.93288826161!2d72.80877122825254!3d19.185188895823067!3m2!1i1024!2i768!4f13.1!2m1!1srural%20schools%20in%20villages%20in%20maharastra!5e0!3m2!1sen!2sin!4v1707053236123!5m2!1sen!2sin"
                      width="650"
                      height="300"
                      style={{ border: 0 }}
                      allowFullScreen=""
                ...
                <Grid item xs={12} md={5}  marginTop="1rem">
                <Grid container spacing={2} >
                    
                    <Grid item xs={11.5}>
                    <Grid container spacing={2} sx={{ backgroundColor: "white", marginBottom: "0.5rem" }}>
                        <Grid item xs={12} style={{ textAlign: "center", marginLeft: "-0.75rem", fontWeight: "600" }}>Book Sessions at Schools</Grid>
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center',itemscontent:'center', marginBottom: '8px' }}>
          <CustomButton backgroundColor="#F47F2A" color="#fff" buttonText="See All" heroBtn={true} />
          {/* <NearMeIcon sx={{ marginLeft: '8px' }} /> */}
        </Box>
                    </Grid>
                    </Grid>
