  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex', borderRadius: '16px', overflow: 'hidden', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }}>
                ...
                <CardContent>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Chip
                      ...
                      variant="soft"
                      label="Education"
                      sx={{ backgroundColor: '#F47F2A', opacity: 0.1, marginRight: '8px' }}
                    />
                  ...
                  <Typography level="body-md">Venue : Palghar, Mumbai, India</Typography>
                  <Typography level="body-md">Date : 29th February 2024</Typography>
        ...
        //   </Typography>
        // <Box sx={{ display: 'flex-between', alignItems: 'center', marginTop: '8px' }}>
        //     <CustomButton backgroundColor="#F47F2A" color="#fff" buttonText="Navigate to Maps" heroBtn={true} />
        //     <NearMeIcon sx={{ marginLeft: '8px' }} />
        //   </Box>
        //        </CardContent>
