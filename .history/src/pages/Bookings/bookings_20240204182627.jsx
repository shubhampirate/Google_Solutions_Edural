...
export default function Booking() {
  ...
  variant="soft"
  label="Education"
  sx={{ backgroundColor: 'rgba(244, 127, 42, 0.1)', color: '#F47F2A', marginRight: '8px' }}
/>
           <br />
        ...
        <Box sx={{ display: 'flex-between', alignItems: 'center',justifyContent: 'center',marginTop: '8px', marginBottom : '8px' }}>
