    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex', borderRadius: '16px', overflow: 'hidden', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }} >
        ...
        <Box
          ...
          <Toolbar />
          <div>
       <Grid container spacing={2} marginTop="0.02rem" paddingLeft={3} paddingRight={2} style={{ backgroundColor: 'white', padding: '10px', borderRadius: '0.5rem' }}>
        <Grid item xs={6}>
          <div style={{ fontSize: '2rem', fontWeight: '500' }}>Welcome Jenil👋</div>
          <div>See all activities</div>
        </Grid>
        <Grid item xs={6} display="flex" justifyContent="flex-end" alignItems="center">
          <button style={{ /* Add your button styles */ }}>Go to Maps</button>
          <button style={{ marginLeft: '10px' /* Add your button styles */ }}>Quick Test</button>
        </Grid>
      </Grid>
    </div>
