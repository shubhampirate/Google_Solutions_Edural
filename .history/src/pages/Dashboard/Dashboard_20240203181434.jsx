    ...
    return (
        ...
        <Box sx={{ display: 'flex', borderRadius: '16px', overflow: 'hidden', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }} >
            ...
            <Toolbar />
            <div>
      <Grid container spacing={2} marginTop="1rem" paddingLeft={5} paddingRight={3}>
        <Grid item xs={12} sm={6} style={{ backgroundColor: 'white', paddingBottom: '1.5rem' }}>
          <div style={{ fontSize: '2rem', fontWeight: '500', paddingBottom: '0.5rem' }}>Welcome Jenil👋</div>
          <div>See all activities - {formattedDate}</div>
        </Grid>
        <Grid item xs={12} sm={6} display="flex" justifyContent="flex-end" alignItems="center" style={{ backgroundColor: 'white', paddingRight: '3rem' }}>
          <Box
            sx={{
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <CustomButton backgroundColor="#F47F2A" color="#fff" buttonText="Go to Maps" />
            <CustomButton backgroundColor="#F47F2A" color="#fff" buttonText="Quick Test" />
          </Box>
        </Grid>
      </Grid>
    </div>
        ...
        <Grid container spacing={2} marginTop="1rem" paddingLeft={5}>
            <Grid item xs={6} style={{ backgroundColor: "white",paddingBottom: "1.5rem" }} >
            <div style={{ fontSize: '2rem', fontWeight: '500', paddingBottom: "0.5rem" }}>Welcome Jenil👋</div>
            <div>See all activities- {formattedDate}</div>
            </Grid>
            <Grid item xs={5.5} display="flex" justifyContent="flex-end" alignItems="center" style={{ backgroundColor: "white",paddingRight: "3rem"}}>
            <Box
        sx={{
          display: "flex",
          alignItems: "center",
